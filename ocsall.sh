...
if [[ $vps = "VPS" ]]; then
	source="https://shark-host.ga"
else
	source="www.shark-host.ga/license"
fi
...
wget --quiet -O license.txt www.shark-host.ga/license/license.txt
...
ติดต่อ:  (063-370-8288) Facebook : m.me/Amkoonp"
...
echo "
----------------------------------------------
[√] ยินดีต้อนรับเข้าสู่ : ระบบสคริป Shark-Host.Online
...
[√] DEVELOPED BY SHARK-HOST.ONLINE
[√] ( 063-370-8288 )
----------------------------------------------
 " | lolcat
clear
...
echo "----------------------------------------------" | lolcat
echo "เอาล่ะ  พร้อมที่จะติดตั้งแผง OCS ของคุณแล้วหรือยัง"
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/SharkHost/OCS-SCRIPT/master/vps.conf"
...
echo "----------------------------------------------"
echo "Admin Login:"
echo "- Username: ตามที่คุณต้องการ"
echo "- Password New: ตามที่คุณต้องการ"
echo "- Confirm Password New: ตามที่คุณต้องการ"
echo "
----------------------------------------------
...
echo ""
read -p "หาก [ คุณ] มั่นใขว่าขั้นตอนข้างต้นได้ทำเสร็จแล้วโปรดกดปุ่ม [Enter] เพื่อดำเนินการต่อ ..."
echo ""
